...
object GSLiveRT {
     ...
     * @param option (NOTNULL)Create Room Option
     */
    @Throws(GameServiceException::class)
    fun createRoom(option: GSLiveOption.CreateRoomOption) {
     ...
     * @param option (NOTNULL) AutoMatch Option
     */
    @Throws(GameServiceException::class)
    fun autoMatch(option: GSLiveOption.AutoMatchOption) {
        if (!GameService.IsGuest) throw GameServiceException("This Function Not Working In Guest Mode")
        option.gsLiveType = GSLiveType.RealTime
     ...
     * @param roomId (NOTNULL)Room's id You Want To Join
     */
    @Throws(GameServiceException::class)
     ...
     * @param role (NOTNULL)Room's Role
     */
    @Throws(GameServiceException::class)
    fun getAvailableRooms(role: String) {
        if (!GameService.IsGuest) throw GameServiceException("This Function Not Working In Guest Mode")
     ...
     * @param data (NOTNULL) Data To BroadCast
     * @param sendType Send Type
     */
    @Throws(GameServiceException::class)
    fun sendPublicMessage(data: String, sendType: GProtocolSendType) {
        if (!GameService.IsGuest) throw GameServiceException("This Function Not Working In Guest Mode")
     ...
     * @param data (NOTNULL) Data To BroadCast
     * @param receiverId (NOTNULL) (Type : MemberID)Player's ID<
     */
    @Throws(GameServiceException::class)
    fun sendPrivateMessage(data: String, receiverId: String) {
        if (!GameService.IsGuest) throw GameServiceException("This Function Not Working In Guest Mode")
     ...
     * @param roomId (NOTNULL) (Type : RoomID)Room's ID
     * @param userId (NOTNULL) (Type : UserID)User's ID
     */
    @Throws(GameServiceException::class)
     ...
     * @param inviteId (NOTNULL) (Type : InviteID) Invite's ID
     */
    @Throws(GameServiceException::class)
    fun inviteUser(inviteId: String) {
        if (!GameService.IsGuest) throw GameServiceException("This Function Not Working In Guest Mode")
     ...
     * @param query (NOTNULL) Player's NickName
     * @param limit (Max = 15) The Result Limits
     */
    @Throws(GameServiceException::class)
    fun findUser(query: String, limit: Int) {
        if (!GameService.IsGuest) throw GameServiceException("This Function Not Working In Guest Mode")
