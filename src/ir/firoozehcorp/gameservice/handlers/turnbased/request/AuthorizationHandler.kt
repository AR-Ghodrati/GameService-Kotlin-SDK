/*
 * <copyright file="AuthorizationHandler.kt" company="Firoozeh Technology LTD">
...
import ir.firoozehcorp.gameservice.models.gsLive.turnbased.AuthPayload
...
internal class AuthorizationHandler : BaseRequestHandler() {
    ...
    companion object {
        const val signature = "AUTHORIZATION"
    }


    private fun doAction(): Packet {
        return Packet(null, TurnBase.ActionAuth, gson.toJson(AuthPayload(TurnBasedHandler.CurrentRoom?.id, TurnBasedHandler.PlayToken)))
    }
