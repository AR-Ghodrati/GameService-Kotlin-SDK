/*
 * <copyright file="CurrentTurnHandler.kt" company="Firoozeh Technology LTD">
...
internal class CurrentTurnHandler : BaseRequestHandler() {
    ...
    companion object {
        const val signature = "CURRENT_TURN"
    }


    private fun doAction(payload: DataPayload): Packet {
        return Packet(TurnBasedHandler.PlayToken, TurnBase.OnCurrentTurnDetail, gson.toJson(payload))
    }
