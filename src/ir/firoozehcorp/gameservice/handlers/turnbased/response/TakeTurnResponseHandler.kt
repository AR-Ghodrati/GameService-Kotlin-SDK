/*
 * <copyright file="TakeTurnResponseHandler.kt" company="Firoozeh Technology LTD">
...
internal class TakeTurnResponseHandler : BaseResponseHandler() {
    ...
    companion object {
        const val action = TurnBase.OnTakeTurn
    }

    override fun handleResponse(packet: Packet, jsonHandler: Gson) {
        val turn = jsonHandler.fromJson(packet.data, Turn::class.java)
        TurnBasedListeners.TakeTurn.invokeListeners(turn)
    }
}