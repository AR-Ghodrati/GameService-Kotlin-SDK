/*
 * <copyright file="SendPublicMessageHandler.kt" company="Firoozeh Technology LTD">
...
internal class SendPublicMessageHandler : BaseRequestHandler() {
    ...
    companion object {
        const val signature = "SEND_PUBLIC_MESSAGE"
    }


    private fun doAction(payload: DataPayload): Packet {
        return Packet(RealTime.ActionPublicMessage, payload.payload, RealTimeHandler.PlayerHash)
    }
