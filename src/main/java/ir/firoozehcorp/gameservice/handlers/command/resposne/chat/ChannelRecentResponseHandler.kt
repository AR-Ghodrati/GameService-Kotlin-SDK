/*
 * <copyright file="ChannelRecentResponseHandler.kt" company="Firoozeh Technology LTD">
...
internal class ChannelRecentResponseHandler : BaseResponseHandler() {
    ...
    companion object {
        const val action = Command.ActionGetLastChats
    }
    ...
    override fun handleResponse(packet: Packet, jsonHandler: Gson) {
        ...
        ChatListeners.ChannelsRecentMessages.invokeListeners(chats)
    }
}