/*
 * <copyright file="GetChannelsMembersRequestHandler.kt" company="Firoozeh Technology LTD">
...
internal class GetChannelsMembersRequestHandler : BaseRequestHandler() {
    ...
    companion object {
        const val signature = "GET_CHANNELS_MEMBERS"
    }


    private fun doAction(detail: RoomDetail): Packet {
        return Packet(CommandHandler.PlayerHash
                , Command.ActionChatRoomDetails, gson.toJson(detail)
        )
    }
