/*
 * <copyright file="InviteUserResponseHandler.kt" company="Firoozeh Technology LTD">
...
internal class InviteUserResponseHandler : BaseResponseHandler() {
    ...
    companion object {
        const val action = Command.ActionInviteUser
    }

    override fun handleResponse(packet: Packet, jsonHandler: Gson) {
        CommandListeners.InvitationSent.invokeListeners(true)
    }
}